        ...
        >
          <motion.div variants={fadeUp} className="mb-16">
            ...
            <p className={`text-xl max-w-2xl mx-auto ${
              ...
              Have questions about SchemaDesigner? Want to contribute or report a bug? We'd love to hear from you!
            </p>
          </motion.div>
        </motion.section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                icon: Mail,
                title: "Email Support",
                description: "Get in touch for general inquiries and business partnerships",
                action: "Send Email",
                color: "green"
              },
              {
                ...
                description: "Join discussions, share schemas, and get help from the community",
              ...
              >
                <motion.div
                  className={`w-16 h-16 mx-auto mb-6 rounded-full flex items-center justify-center ${
                    contact.color === 'blue' ? (isDark ? 'bg-blue-500/20 text-blue-400' : 'bg-blue-100 text-blue-600') :
                    contact.color === 'green' ? (isDark ? 'bg-green-500/20 text-green-400' : 'bg-green-100 text-green-600') :
