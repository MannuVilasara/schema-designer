			...
			<main className="pt-20 relative z-10">
				...
				>
					<motion.div variants={fadeUp} className="mb-16">
						...
						>
							Get started with your MongoDB schema design in
							minutes. Our intuitive interface makes database
							design effortless.
						</p>
					</motion.div>
				</motion.section>
						...
						{[
							{
								...
								description:
									'Start by adding collections to your schema. Simply click and drag to position them on the canvas. Each collection represents a document structure in your MongoDB database.',
								icon: Database,
								color: 'blue',
								details: [
							...
							},
							{
								...
								title: 'Define Fields',
								description:
									'Add fields to your collections with data types, validation rules, and relationships. Configure indexes, constraints, and references between collections.',
								icon: Code,
								color: 'purple',
								details: [
									'Multiple data types',
							...
							},
							{
								...
								title: 'Export & Use',
								description:
									'Generate code for Mongoose, Prisma, or JSON schemas. Export your design and integrate it directly into your projects with production-ready code.',
								icon: Download,
								color: 'green',
								details: [
									'Mongoose schemas',
				...
				>
					<motion.div variants={fadeUp}>
						...
						>
							Built for developers who want to move fast without
							sacrificing quality. Our visual approach to schema
							design helps you catch issues early and collaborate
							effectively.
						</p>
						<motion.button
