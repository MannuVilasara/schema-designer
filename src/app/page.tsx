				...
				<animated.div
					style={{
						...
						transform: floatingSpring.transform.to(
							(t) =>
								`${t.replace('translateY(-10px)', 'translateY(-15px)')}`
						),
					}}
			...
			>
				<div className="max-w-7xl mx-auto text-center relative z-10">
					...
					>
						...
						>
							Create, visualize, and manage your MongoDB database
							schemas with an intuitive drag-and-drop interface.
							Build relationships between collections and export
							your designs.
						</motion.p>
			...
			<section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<motion.p
						...
						transition={{ duration: 0.8, delay: 0.2 }}
					>
						Start creating professional MongoDB schemas in minutes.
						No setup required.
					</motion.p>
					<motion.div
						initial={{ opacity: 0, y: 30 }}
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex flex-col md:flex-row justify-between items-center">
						...
						<motion.p
							...
							transition={{ duration: 0.8, delay: 0.4 }}
						>
							© 2025 Manpreet Singh. Built with Next.js and
							ReactFlow.
						</motion.p>
					</div>
				</div>
