    ...
    <div className={`min-h-screen transition-colors duration-300 relative overflow-hidden ${
      ...
      <main className="pt-20 relative z-10">
        ...
        >
          ...
          >
            Create, visualize, and manage your MongoDB schemas with a clean drag-and-drop interface.
          </motion.p>
          <motion.div
            variants={fadeUp}
        ...
        >
          {[
            { icon: Users, label: "Active Users", value: counters.users, color: "blue" },
            { icon: Database, label: "Schemas Created", value: counters.schemas, color: "purple" },
            { icon: Download, label: "Downloads", value: counters.downloads, color: "cyan" }
          ].map((stat, index) => (
            <motion.div
              key={stat.label}
              variants={fadeUp}
            ...
            >
              <motion.div
                className={`w-12 h-12 mx-auto mb-4 rounded-lg flex items-center justify-center ${
                  ...
                  stat.color === 'purple' ? (isDark ? 'bg-purple-500/20' : 'bg-purple-100') :
              ...
              <div className={`transition-colors group-hover:scale-105 ${
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              >
                <f.icon className={`w-6 h-6 mb-4 transition-colors ${
