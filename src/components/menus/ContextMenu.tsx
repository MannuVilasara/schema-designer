      ...
      <div className="py-1">
        {isEmptyArea ? (
          <Button
            ...
            onClick={() => handleAction(() => onCreateCollection?.({ x, y }))}
          >
          ...
          <>
            ...
            <Button
              ...
              onClick={() =>
                handleAction(() => onEditCollection?.(collectionId, { x, y }))
              }
            >
            ...
            <Button
              ...
              onClick={() => handleAction(() => onDuplicate(collectionId))}
            >
            ...
            <Button
              ...
              onClick={() =>
                handleAction(() => onDelete(collectionId, { x, y }))
              }
            >
