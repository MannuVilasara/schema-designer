		...
		<div className="relative flex h-full">
			<AnimatePresence>
				<motion.div
					...
					animate={
						leftSidebarDocked ? { x: 0 } : dockVariants.floating
					}
					exit={{
															...
															0 ? (
																...
																col.fields.map(
																	(
																		...
																		const isDragging =
																			draggedField?.collectionId ===
																				col.id &&
																			draggedField?.fieldIndex ===
																				idx;
																		const isDropTarget =
																			dragOverField?.collectionId ===
																				col.id &&
																			dragOverField?.fieldIndex ===
																				idx;
																		const canDrag =
																			field.name !==
																				'createdAt' &&
					...
					return collection ? (
						<EditCollectionModal
							...
							onSave={(collectionId, name) => {
								updateCollection(
									editCollectionModal.collectionId,
									name
								);
			...
			{deleteFieldDialog &&
				(() => {
					...
					const field =
						collection?.fields[deleteFieldDialog.fieldIndex];
					return field ? (
